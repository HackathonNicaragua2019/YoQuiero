...
export default class Navbar3 extends Component {
  render() {
    return (
      <>
        <nav className="sub-nav-bar d-flex justify-content-center letra contenido">
          ...
          <div className="d-flex justify-content-center align-items-center dropdown tam-letra ilumi">
            <a
              href="/404"
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown ">
              ...
              <a className="item letra" href="#">
                Ver Todos
              </a>
            </div>
          </div>

          <div className="d-flex justify-content-center align-items-center ilumi navbar-link tam-letra">
            <a
              href="/404"
              className="nav-bar-link dropdown-toggle"
              id="navbarDropdown"
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown ">
              <a className="dropdown-item tam-monedas-icon" href="#">
                <FaRegMoneyBillAlt />
                -Cordoba
              </a>
              <a className="dropdown-item tam-monedas-icon" href="#">
